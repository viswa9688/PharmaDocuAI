...
- **Core Processing**:
    ...
    - **Temporal Validation**: Dates extracted from pages 3+ are validated against the batch commencement/completion window. Pages 1-2 are excluded (page 1 contains document metadata that naturally predates manufacturing, page 2 contains the batch details section itself). Alerts are generated for dates that fall outside this window with "sequence_error" category.
